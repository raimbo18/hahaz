...
class Square(object):
    ...
    @loggedIn
    def SQsendImage(self, to, path):
        objectId = self.sendSquareMessage(squareChatMid=to, text=None, contentType = 1).id
    ...
    @loggedIn
    def sendSquareMessages(self,squareChatMid, messageObject):
        rq = SendMessageRequest()
        rq.squareChatMid = squareChatMid
        rq.squareMessage = SquareMessage()
        msg = messageObject
