                ...
                if msg.contentType == 0:
                    if msg.text is None:
                        return
                            ...
                            if ditsa.startswith('prefix set '):self.client.sendMessage(to,self.client.mykeyset(self.client.adityasplittext(ditsa,'s'),wait))
                            ...
                            if dits == 'resetmentionme':wait['ROM'] = {};self.client.sendMessage(to, " 「 Mentionnes 」\nType: Resetion Mentionnes\nStatus: Success Reset")
